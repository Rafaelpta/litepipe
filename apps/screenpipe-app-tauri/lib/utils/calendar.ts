...
// litepipe: Google Calendar OAuth was proxied through the upstream vendor's
// servers and was removed with the connections stack. The provider reports
// permanently disconnected; Apple (native) and ICS calendars remain.
