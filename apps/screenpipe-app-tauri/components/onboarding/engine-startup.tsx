...
export default function EngineStartup({
  ...
  const startSummaryStream = useCallback(
    async (digest: string) => {
      ...
      // litepipe: the onboarding summary only runs against a provider the user
      // configured (local or bring-your-own-key). There is no hosted fallback.
      if (
        ...
        // No configured provider yet. Skip the summary quietly; the rest of
        // onboarding does not depend on it.
...
if the input is sparse, just describe what little you have warmly. don't apologize for not having more.`;
      ...
      <div className="w-full flex flex-col items-center justify-center min-h-[400px]">
        ...
        >
          ...
          <div className="w-full min-h-[140px] flex items-start">
            {noActivityYet ? (
              <motion.p
                ...
                animate={{ opacity: 1 }}
              >
                litepipe is up and watching. as you work, what you see and
          ...
          <p className="font-mono text-[10px] text-muted-foreground/50 text-center lowercase tracking-wide">
            ...
            <button
              type="button"
              onClick={() => openUrl("https://github.com/Rafaelpta/litepipe#readme")}
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center min-h-[400px]">
      ...
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img className="w-12 h-12 mb-2" src="/128x128.png" alt="litepipe" />
            ...
            >
              ...
              {spawnErrorKind === "permission" ? (
                <>
                  ...
                  <button
                    onClick={() =>
                      openUrl("https://github.com/Rafaelpta/litepipe#readme")
                    }
