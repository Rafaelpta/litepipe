  ...
  const permissions: PermissionDef[] = [
    {
      ...
      subtitle: "Lets litepipe index what's on your screen — windows, docs, chats, code",
    ...
    },
    {
      ...
      subtitle: "Lets litepipe transcribe your voice in meetings and calls",
    ...
    },
    {
      ...
      subtitle: "Lets litepipe understand app content without OCR",
    ...
    },
    {
      ...
      subtitle: "So litepipe knows what you were reading, not just what the pixels say",
      check: async () => {
    ...
    >
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="font-mono text-[10px] text-muted-foreground mt-1 text-center max-w-xs">
          Enable these permissions to get the most out of litepipe
        </p>
      </div>
