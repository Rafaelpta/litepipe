...
export function RetentionSettings() {
  ...
  const enabled = settings.localRetentionEnabled ?? true;
        ...
        <AlertDialogContent data-testid="retention-mode-confirm-dialog">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {pendingMode === "media" ? (
                <>
                  every day, litepipe will delete video and audio files older
                  than {retentionDays} days. transcripts, ocr text, and your
                  app/window timeline stay searchable.
                </>
              ) : (
                <>
                  every day, litepipe will permanently delete <em>all</em>{" "}
