                  ...
                  try {
                    ...
                    try {
                      ...
                      toast({
                        ...
                        description: "litepipe restarted to apply the change.",
                      });
                    } catch (e) {
                      toast({
                        title: "failed to restart litepipe",
                        description: "restart litepipe manually to apply the change.",
                        variant: "destructive",
                      });
                    }
                  } finally {
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                    ...
                    <HelpTooltip text="When enabled, the litepipe overlay will be visible in screen recordings and screenshots made by other apps like OBS or Screen Studio." />
                  </h3>
                ...
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                      ...
                      <HelpTooltip text="When enabled, clicking the X on the Home window hides it and removes it from the Windows taskbar. litepipe keeps running in the system tray — click the tray icon to bring the window back." />
                    </h3>
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    toast({
                      ...
                      description: checked
                        ? "Click the tray icon to bring litepipe back."
                        : undefined,
                    });
                  }}
                />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Overlay showing the litepipe shortcut</p>
                </div>
              </div>
              <Switch
                id="shortcut-overlay"
