...
export const CurrentFrameTimeline: FC<CurrentFrameTimelineProps> = ({
	...
	return (
		...
		>
			...
			{/* litepipe: the shift+drag region OCR overlay was removed — it sent
			    the cropped frame to the hosted AI endpoint, which does not exist
			    in this fully-local build. Text extraction still works via the
			    selectable text layer above. */}
