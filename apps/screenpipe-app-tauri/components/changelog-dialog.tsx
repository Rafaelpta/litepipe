...
// litepipe: the changelog is the bundled CHANGELOG.md shipped in the app. There
// is no remote changelog service to call.
    ...
    <Dialog open={showChangelogDialog} onOpenChange={onClose}>
      <DialogContent className="w-11/12 max-w-3xl p-0 h-[80vh] overflow-hidden flex flex-col">
        <div className="px-6 pt-6 pb-4 border-b border-border flex items-center justify-between">
          ...
          <a
            href="https://github.com/Rafaelpta/litepipe/releases"
            target="_blank"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {loading ? (
            ...
            <div className="text-sm text-muted-foreground font-mono">
              the changelog ships with the app. see all releases on{" "}
              <a
                href="https://github.com/Rafaelpta/litepipe/releases"
                target="_blank"
                rel="noopener noreferrer"
