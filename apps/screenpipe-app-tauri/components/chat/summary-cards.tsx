...
interface SummaryCardsProps {
  ...
  // litepipe: connection-setup props are accepted for caller compatibility
  // but ignored — the connections page was removed.
  ...
  return (
    <div className="relative flex flex-col items-center py-4 px-4">
      ...
      <div className="grid grid-cols-3 gap-1.5 w-full max-w-lg mb-2">
        ...
        {/* litepipe: connection-setup suggestion cards removed with the connections page. */}
      </div>
