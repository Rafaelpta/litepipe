...
function ComingUpEmptyState({
  ...
  // litepipe: the connections page is gone, so the "calendars" button now
  // reveals the provider chips inline instead of navigating away.
