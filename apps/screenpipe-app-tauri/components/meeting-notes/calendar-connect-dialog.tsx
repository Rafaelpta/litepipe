...
// litepipe: "google" provider removed — its OAuth token exchange was proxied
// through screenpipe servers.
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        litepipe reads event titles, times, and attendees so meeting notes can
...
function IcsCalendarConnect({
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Paste a private or public ICS/webcal subscription URL. litepipe polls
