            ...
            <div className="absolute inset-0 z-40 flex items-center justify-center bg-background p-4">
                <div className="w-full max-w-sm border border-border bg-card p-4 shadow-sm">
                  ...
                  <p className="text-xs leading-5 text-muted-foreground">
                    {sessionAccessRequest.alreadyGranted
                      ? "litepipe is about to copy browser session cookies. macOS may ask for browser Safe Storage access next."
                      : "litepipe can use your browser sessions so the agent opens sites already signed in. This applies to all sites. It does not read saved passwords."}
                  </p>
                  ...
                  {v20CookieBlock.reason === "locked" ? (
                    <>
                      <p className="text-xs leading-5 text-muted-foreground">
                        ...
                        database. litepipe cannot read it while the browser is
                        open.
                      </p>
                      <p className="mt-2 text-xs leading-5 text-muted-foreground">
                        Connect the litepipe Browser Bridge extension to share
                    ...
                    <>
                      <p className="text-xs leading-5 text-muted-foreground">
                        ...
                        app-bound encryption prevents litepipe from reusing
                        them directly.
                      </p>
                      <p className="mt-2 text-xs leading-5 text-muted-foreground">
                        Connect the litepipe Browser Bridge extension to reuse
